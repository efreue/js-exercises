...
var getCircle = function(id, posLeft, posTop, color, transparent, hidden) {
    var circle = createElement('div');
    circle.id = id;
    circle.className = "shape " + transparent + " " + hidden + " " + color;
...
var addBall = function() {
    ...
    table.appendChild(getCircle(0, 20, 135, 'red', 'transparent ', ''));
    table.appendChild(getCircle(1, 100, 40, 'red', '', 'hidden '));
    table.appendChild(getCircle(2, 175, 40, 'red', 'transparent', ''));
